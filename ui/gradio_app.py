...
def create_gradio_interface():
    ...
    # Custom styling in Gradio 6.x is handled through built-in themes and components
    # Previous custom_css variable (237 lines) removed as it was unused dead code
    with gr.Blocks(
